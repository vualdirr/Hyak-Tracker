// src/modules/playervideos/sibnet/index.js
...
export default {
  ...
  async run(api) {
    api.log("sibnet (player) module attached");
    ...
    const autoMarker = createAutoMarker({
      getEpisodeKey: () => {
        ...
        return "sibnet:" + (document.referrer || location.href);
      },
    ...
    const attach = async (v) => {
      ...
      chrome.runtime.sendMessage({
        ...
        kind: "step",
        scope: "playervideos/sibnet",
        message: "Player vidéo détecté (sibnet)",
      });
    ...
    return () => {
      ...
      api.log("sibnet (player) module detached");
    };
  },
};
